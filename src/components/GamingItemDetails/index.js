...
const GamingItemDetails = props => {
  ...
  const renderSuccessView = () => (
    <GamingDetailsContainer isDarkTheme={isDarkTheme}>
      <PlayerWrapper>
        <ReactPlayer
      ...
      <GameTitle isDarkTheme={isDarkTheme}>{gamingVideo.title}</GameTitle>

      <GameStats isDarkTheme={isDarkTheme}>
        {gamingVideo.viewCount} Watching Worldwide
      </GameStats>

      <GameDescription isDarkTheme={isDarkTheme}>
        {gamingVideo.description}
      </GameDescription>
    </GamingDetailsContainer>
  )
